  ...
  return (
    <div className="mx-auto min-h-screen max-w-[1440px] bg-[#F4F1EA] text-[#141414]">
      ...
      <div className="grid grid-cols-1 items-center gap-12 px-5 pb-16 pt-[72px] min-[900px]:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)] md:px-10">
        ...
        {/* SDK terminal */}
        <div className="min-w-0 rounded-[20px] border-2 border-[#141414] bg-[#141414] p-7 font-mono text-[14.5px] leading-loose text-[#b9b6ac] shadow-[8px_8px_0_#D97757]">
          ...
          <div>
            <span className="text-[#8a8578]">$</span> kovio connect --fleet
          </div>
          ...
          <div className="mt-3">
            <span className="text-[#8a8578]">→</span> <span className="font-bold text-[#D97757]">fleet is now earning</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-10 border-y-2 border-[#141414] bg-[#141414] px-5 py-[26px] text-[#F4F1EA] md:px-10">
        ...
        <span className="text-[13px] text-[#8a8578] min-[900px]:ml-auto">Multi-OEM ecosystem, in production</span>
      </div>
        ...
        <div className="grid grid-cols-1 items-center gap-12 min-[900px]:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)]">
          <div className="min-w-0 overflow-hidden rounded-2xl border-2 border-[#141414] bg-white shadow-[8px_8px_0_#D97757]">
            <div className="flex items-center gap-2.5 bg-[#141414] px-[18px] py-3">
              ...
              <span className="text-[12px] font-bold tracking-[1px] text-[#8a8578]">KOVIO OPERATOR DASHBOARD</span>
            </div>
            <div className="flex flex-col gap-3 p-6">
              <div className="grid grid-cols-[1.5fr_1.1fr_.9fr] items-center border-b-2 border-[#141414] pb-2.5 text-[11px] font-bold tracking-[1.5px] text-[#8a8578]">
                <span>UNIT</span>
                <span>STATUS</span>
                <span className="text-right">EARNINGS TODAY</span>
              </div>
              {UNITS.map((u) => (
                <div key={u.unit} className={`grid grid-cols-[1.5fr_1.1fr_.9fr] items-center text-[14px] font-semibold ${u.live ? '' : 'text-[#8a8578]'}`}>
                  <span>{u.unit}</span>
                  <span
                    className={`inline-flex items-center gap-1.5 justify-self-start rounded-full px-2.5 py-1 text-[10.5px] font-bold tracking-[1px] ${
                      u.live ? 'border-[1.5px] border-[#1f6b3a] bg-[#E4F2E4] text-[#1f6b3a]' : 'border-[1.5px] border-[#b9b6ac] bg-[#F0EDE6] text-[#8a8578]'
                    }`}
                  >
              ...
              <div className="mt-1.5 flex items-center justify-between rounded-[10px] bg-[#141414] px-4 py-3 text-[#F4F1EA]">
                <span className="text-[11px] font-bold tracking-[1.5px] text-[#D97757]">NEXT PAYOUT · AUTOMATIC</span>
                <span className="font-display text-[16px]">FRI</span>
              </div>
            </div>
          </div>
          <div className="flex min-w-0 flex-col gap-5">
            <div className="text-[13px] font-bold tracking-[2px] text-[#8a8578]">OPERATOR DASHBOARD</div>
            ...
            >
              <span className="text-[#D97757]">●</span> INCLUDED WITH THE SDK
            </a>
          </div>
        </div>
      </div>
