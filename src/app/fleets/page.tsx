...
export default function FleetsPage() {
  return (
    <div className="mx-auto min-h-screen max-w-[1440px] bg-[#F4F1EA] text-[#141414]">
      <Nav active="fleets" cta={{ href: '/contact?type=fleet', label: 'Contact us →' }} />
      ...
      <div className="grid grid-cols-1 items-center gap-12 px-5 pb-10 pt-10 md:pb-16 md:pt-[72px] min-[900px]:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)] md:px-10">
        <div className="flex min-w-0 flex-col gap-6">
          ...
          <p className="m-0 max-w-[560px] text-[20px] leading-normal text-[#141414]">
        ...
        >
          ...
          <div className="mb-[18px] flex gap-2">
            <div className="h-3 w-3 rounded-full bg-[#141414]" />
            <div className="h-3 w-3 rounded-full bg-[#141414]" />
            <div className="h-3 w-3 rounded-full bg-[#D97757]" />
          </div>
          <div>
            <span className="text-[#F4F1EA]">$</span> kovio connect --fleet
          </div>
          ...
          <div className="mt-3">
            <span className="text-[#F4F1EA]">→</span> <span className="font-bold text-[#D97757]">fleet is now earning</span>
          </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-10 border-y-2 border-[#141414] bg-[#141414] px-5 py-[26px] text-[#F4F1EA] md:px-10">
        ...
        <span className="text-[13px] text-[#F4F1EA] min-[900px]:ml-auto">Multi-OEM ecosystem, in production</span>
      </div>
      ...
      <div className="px-5 pb-12 md:px-10 md:pb-[72px]">
        <div className="grid grid-cols-1 items-center gap-12 min-[900px]:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)]">
          ...
          >
            ...
            <div className="flex items-center gap-2.5 bg-[#141414] px-[18px] py-3">
              <div className="flex gap-1.5">
                <div className="h-2.5 w-2.5 rounded-full bg-[#141414]" />
                <div className="h-2.5 w-2.5 rounded-full bg-[#141414]" />
                <div className="h-2.5 w-2.5 rounded-full bg-[#D97757]" />
              </div>
              <span className="text-[12px] font-bold tracking-[1px] text-[#F4F1EA]">KOVIO OPERATOR DASHBOARD</span>
            </div>
            <div className="flex flex-col gap-3 p-6">
              <div className="grid grid-cols-[1.5fr_1.1fr_.9fr] items-center border-b-2 border-[#141414] pb-2.5 text-[12px] font-bold tracking-[1.5px] text-[#141414]">
                <span>UNIT</span>
                <span>STATUS</span>
                <span className="text-right">EARNINGS TODAY</span>
              </div>
              {UNITS.map((u) => (
                <div key={u.unit} className={`grid grid-cols-[1.5fr_1.1fr_.9fr] items-center text-[14px] font-semibold ${u.live ? '' : 'text-[#141414]'}`}>
                  <span>{u.unit}</span>
                  <span
                    className={`inline-flex items-center gap-1.5 justify-self-start rounded-full px-2.5 py-1 text-[12px] font-bold tracking-[1px] ${
                      u.live ? 'border-[1.5px] border-[#1f6b3a] bg-[#E4F2E4] text-[#1f6b3a]' : 'border-[1.5px] border-[#6B6558] bg-[#F0EDE6] text-[#141414]'
                    }`}
                  >
          ...
          <div className="flex min-w-0 flex-col gap-5">
            <div className="text-[13px] font-bold tracking-[2px] text-[#141414]">OPERATOR DASHBOARD</div>
            <h2 className="m-0 font-display text-[30px] uppercase leading-none tracking-[-1px] min-[900px]:text-[44px]">
              See every robot earning.
            </h2>
            <p className="m-0 max-w-[480px] text-[17px] leading-[1.55] text-[#141414]">
      ...
      <Footer cta={{ href: '/contact?type=fleet', label: 'CONTACT US' }} />
    </div>
  )
}
